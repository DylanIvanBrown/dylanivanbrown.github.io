---
layout: post
title: "Learning from the Fortnite pivot"
subtitle: "It's more important, and realistic, to be ready for the opportunity than it is to be a visionary"
description: "Fortnite's pivot to Battle Royale wasn't luck. It was the result of a flexible platform and the ability to execute fast. Here's what software teams can learn from that."
excerpt: "This approach is all about being in the right position to pursue an opportunity in a shorter timeframe, as such reducing the risk by being able to pivot to another if that opportunity does not turn out how you wanted."
date: 2026-04-12 00:00:00 -0000
# updated:
categories: [engineering]
tags: [software-engineering, engineering-design, leadership, opinion, case-study]
---
...
Fortnite had been having underwhelming success in the 6 years since the first trailer was revealed (2011), but with that [6 years worth of work](https://tech.yahoo.com/gaming/articles/part-2-five-years-fortnite-090000028.html) the team were able to quickly pivot to capture the moment around battle royale games and become the leader in the space they are today.

In game development these days games can often take 5 or more years to produce, and can be quickly shut down when they are not an instant success, so chasing a trend that is happening now with a new project is a big bet on that trend still being popular in 5+ years _and_ being able to overcome the early movers in that space.

## The Lesson: Innovate or Be Flexible

There have been a lot of companies that have chased the kind of success that Fortnite has had, it's very appealing to any executive or publisher to have a game like Fortnite that can bring in over [$1 Billion of lifetime revenue](https://www.businessofapps.com/data/fortnite-statistics/) and become one of the dominant cultural forces in the gaming ecosystem. This success has seen a lot of companies chasing the "live-service" free-to-play model and failing. A lot of those companies are focusing on the wrong lessons from Fortnite's success.
...
For example we built out a user management system for [Rori](https://rori.ai/) that we are now applying to [Tari](https://www.risingacademies.com/tari). This has allowed us to build out a data pipeline and a stable memory for Tari in much quicker time than we would if building it from scratch.
